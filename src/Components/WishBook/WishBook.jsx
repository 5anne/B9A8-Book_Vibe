...
const WishBook = ({ markedBook }) => {
    ...
    return (
        <div className="lg:flex gap-8 border-[1px] rounded-2xl p-6 mt-8">
            ...
            <div className="w-full">
                ...
                <div className="lg:flex items-center gap-6 font-medium text-[#23BE0A] text-base">
                ...
                <div className="lg:flex items-center gap-6 text-[#13131399] text-base border-b-2 pb-4">
                ...
                <div className="mt-4">
                    ...
                    <Link to={`/details/${bookId}`}>
                        <button className="text-[#FFFFFF] hover:bg-[#23BE0ACC] text-base bg-[#23BE0A] rounded-3xl px-4 py-1 mt-2 lg:mt-0">View Details</button>
                    </Link>
                </div>
            </div>
        </div>
